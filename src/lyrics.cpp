...
void createLyricsOverlay(lv_obj_t* parent) {
    ...
    // Position at bottom of art image: art is at x=30, y=30, size=420×420
    // Container bottom (y=270+180=450) = art bottom (y=30+420=450) ✓
    // Container right (x=30+420=450) = art right (x=30+420=450) ✓
