 ...
 * Size: 80 px
 * Bpp: 4
 * Opts: --font node_modules/@mdi/font/fonts/materialdesignicons-webfont.ttf --size 80 --format lvgl --bpp 4 --no-compress --range 0xF186C -o src/fonts/lv_font_mdi_80.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 1280, .box_w = 20, .box_h = 68, .ofs_x = 30, .ofs_y = -4}
};
...
{
    {
        .range_start = 989292, .range_length = 1, .glyph_id_start = 1,
